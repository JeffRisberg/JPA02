...
public class ArchaiusAppConfig implements AppConfig {
    ...
    public String getString(final String key) {
        return DynamicPropertyFactory.getInstance().getStringProperty(key, "").get();
    }
    ...
    public int getInt(final String key) {
        return DynamicPropertyFactory.getInstance().getIntProperty(key, 1).get();
    }
    ...
    public long getLong(final String key) {
        return DynamicPropertyFactory.getInstance().getLongProperty(key, 1L).get();
    }
    ...
    public double getDouble(final String key) {
        return DynamicPropertyFactory.getInstance().getDoubleProperty(key, 1.0).get();
    }
    ...
    public boolean getBoolean(final String key) {
        return DynamicPropertyFactory.getInstance().getBooleanProperty(key, false).get();
    }
